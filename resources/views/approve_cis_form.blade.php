                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <a href="approve_cis_form/view_cis/{{Crypt::encrypt($msp->id)}}" type="submit" class="btn btn-primary">View</a>  
                                        <a href="approve_cis_form/change_status/{{Crypt::encrypt($msp->id)}}" type="submit" class="btn btn-warning">Change Status</a>  
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
