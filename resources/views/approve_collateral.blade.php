                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-0" style="height: 630px;">
                            ...
                            <thead>
                                ...
                                <th style="text-align: center">Collateral Type</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">{{$msp->collateral_type}}</td>
                                    ...
                                    <td style="text-align: center">
                                        <a href="http://fvis-userpanel.ketekmall.com/public/files/col/{{$msp->collateral_doc}}" type="submit" class="btn btn-warning">View</a>    
                                    </td>
                                </tr>    
                                @endforeach
                            </tbody>
